...
const HOJE_JOGOS = [
  { time1: 'Portugal', flag1: 'POR', time2: 'Rep. Tcheca', flag2: 'CZE', horario: '15:00', estadio: "Levi's Stadium", cidade: 'Santa Clara, CA', placar: '2 x 1', status: 'Encerrado', grupo: 'Grupo E' },
  { time1: 'Turquia', flag1: 'TUR', time2: 'Georgia', flag2: 'GEO', horario: '15:00', estadio: 'AT&T Stadium', cidade: 'Arlington, TX', placar: '3 x 1', status: 'Encerrado', grupo: 'Grupo F' },
  { time1: 'Marrocos', flag1: 'MAR', time2: 'Zambia', flag2: 'ZAM', horario: '19:00', estadio: 'SoFi Stadium', cidade: 'Inglewood, CA', placar: null, status: 'Hoje 19h BRT', grupo: 'Grupo G' },
  { time1: 'Colombia', flag1: 'COL', time2: 'Senegal', flag2: 'SEN', horario: '19:00', estadio: 'Hard Rock Stadium', cidade: 'Miami Gardens, FL', placar: null, status: 'Hoje 19h BRT', grupo: 'Grupo H' },
];
                ...
                <div key={i} style={{ background: '#1a1a1a', border: '1px solid #333', borderRadius: '12px', padding: '24px', display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div style={{ textAlign: 'center', minWidth: '200px' }}>
                    <div style={{ background: '#111', borderRadius: '8px', padding: '10px 20px', marginBottom: '8px' }}>
                      <div style={{ fontSize: '26px', fontWeight: 900, color: j.placar ? '#ffdf00' : '#fff', letterSpacing: '3px' }}>{j.placar || j.horario}</div>
                      <div style={{ fontSize: '12px', color: j.placar ? '#4ade80' : '#f59e0b', fontWeight: 600, marginTop: '2px' }}>{j.placar ? 'Encerrado' : 'Hoje ' + j.horario + ' BRT'}</div>
                    </div>
                    ...
                    <div style={{ background: '#0d2a0d', borderRadius: '8px', padding: '10px 14px', border: '1px solid #1a4a1a' }}>
                      <div style={{ fontSize: '14px', fontWeight: 700, color: '#fff' }}>Estadio: {j.estadio}</div>
                      <div style={{ fontSize: '12px', color: '#888', marginTop: '3px' }}>Local: {j.cidade}</div>
                    </div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '12px' }}>
                    {lista.map((j, ji) => (
                      <button key={ji} onClick={() => setJogador(j)}
                        ...
                        <div style={{ width: '60px', height: '60px', borderRadius: '50%', background: 'linear-gradient(135deg, #009c3b, #006828)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 10px', fontSize: '20px', fontWeight: 900, color: '#ffdf00', border: '2px solid #ffdf00' }}>{j.num}</div>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.9)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }} onClick={() => setJogador(null)}>
          <div style={{ background: '#1a1a1a', borderRadius: '16px', maxWidth: '520px', width: '100%', maxHeight: '90vh', overflowY: 'auto', border: '1px solid #333' }} onClick={e => e.stopPropagation()}>
            <div style={{ background: 'linear-gradient(135deg, #009c3b, #006828)', padding: '24px', borderRadius: '16px 16px 0 0', display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '68px', height: '68px', borderRadius: '50%', background: 'rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: 900, color: '#ffdf00', border: '3px solid #ffdf00', flexShrink: 0 }}>{jogador.num}</div>
              <div style={{ flex: 1 }}>
