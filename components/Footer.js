        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="footer-links" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/comunidade">Comunidade</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/imigracao">Imigração</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/negocios">Negócios</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/saude">Saúde</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/esportes">Esportes</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/categoria/cultura-lazer">Cultura e Lazer</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="footer-links" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/">Início</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/sobre">Sobre Nós</Link></li>
              <li style={{ listStyle: 'none', display: 'block' }}><Link href="/anuncie">Anuncie</Link></li>
            </ul>
          </div>
